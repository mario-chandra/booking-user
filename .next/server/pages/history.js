...
const getServerSideProps = async ({ req , query  })=>{
    ...
    const data = await axios__WEBPACK_IMPORTED_MODULE_5___default().get(`${"http://44.204.27.29:8000"}/book/history?nim=${nim}`, {
        headers: {
...
History.layout = _layout_PageLayout__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z;
...
var __webpack_exports__ = __webpack_require__.X(0, [895,61,500,39,921], () => (__webpack_exec__(5984)));
